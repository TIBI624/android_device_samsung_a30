...
repo init -u https://github.com/Evolution-X/manifest.git -b fourteen --git-lfs
...
|------------|------|---------|
| [universal7885-common](https://github.com/eurekadevelopment/android_device_samsung_universal7885) | device/samsung/universal7885-common | Common HAL & configs |
